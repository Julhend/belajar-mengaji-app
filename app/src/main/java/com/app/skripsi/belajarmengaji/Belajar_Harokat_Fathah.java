...
public class Belajar_Harokat_Fathah extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final MediaPlayer SuaraAlif = MediaPlayer.create(this, R.raw.fatah_a); //Memanggil nama lagu
        ...
        ImageButton ButtonSuara = (ImageButton) this.findViewById(R.id.fatah_a); //Variabel button
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent explicit_intent = new Intent(Belajar_Harokat_Fathah.this,
