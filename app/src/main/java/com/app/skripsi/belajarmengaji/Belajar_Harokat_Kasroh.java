...
public class Belajar_Harokat_Kasroh extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     final MediaPlayer SuaraAlif = MediaPlayer.create(this, R.raw.kasroh_i); //Memanggil nama lagu
        ...
        final MediaPlayer SuaraDo = MediaPlayer.create(this, R.raw.kasroh_zhi);
        ...
        ImageButton ButtonSuara = (ImageButton) this.findViewById(R.id.kasroh_i); //variabel button
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent explicit_intent = new Intent(Belajar_Harokat_Kasroh.this,
