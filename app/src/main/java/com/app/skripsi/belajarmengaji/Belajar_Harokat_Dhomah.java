...
public class Belajar_Harokat_Dhomah extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final MediaPlayer SuaraAlif = MediaPlayer.create(this, R.raw.u); //Memanggil nama lagu
        ...
        final MediaPlayer SuaraDo = MediaPlayer.create(this, R.raw.dzhu);
        ...
        final MediaPlayer SuaraHA = MediaPlayer.create(this, R.raw.huuu);
        ...
        ButtonSuara17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_domahtain_dzuu);
                TampilGambar.startAnimation(animScale);
               SuaraDo.start();
            }
        });
