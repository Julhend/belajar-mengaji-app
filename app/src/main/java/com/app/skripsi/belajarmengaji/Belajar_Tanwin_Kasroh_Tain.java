...
public class Belajar_Tanwin_Kasroh_Tain extends Activity {
    ...
    protected void onCreate(Bundle Kasroh_Tain){
       ...
       final MediaPlayer SuaraAlif = MediaPlayer.create(this, R.raw.tanwin_kasroh_iin); //Memanggil nama lagu
        ...
        final MediaPlayer SuaraSa = MediaPlayer.create(this, R.raw.tanwin_kasroh_tsin);
      ...
      //  final MediaPlayer SuaraSyin = MediaPlayer.create(this, R.raw.button);
       ...
       // final MediaPlayer SuaraMim = MediaPlayer.create(this, R.raw.button);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent explicit_intent = new Intent(Belajar_Tanwin_Kasroh_Tain.this,
