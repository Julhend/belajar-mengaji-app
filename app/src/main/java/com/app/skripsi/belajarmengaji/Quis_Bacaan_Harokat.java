...
public class Quis_Bacaan_Harokat extends Activity {
    ...
    int s,s1,j1,j2,j3;
    int skor = 0;
    Bacaan_Harokat hijaiyah = new Bacaan_Harokat();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_quis_bacaan_harokat);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent explicit_intent = new Intent(Quis_Bacaan_Harokat.this,
