...
public class Quis_Bacaan_Tanwin extends Activity {
    ...
    int s,s1,j1,j2,j3;
    int skor = 0;
    Bacaan_Tanwin hijaiyah = new Bacaan_Tanwin();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_quis_bacaan_tanwin);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent explicit_intent = new Intent(Quis_Bacaan_Tanwin.this,
