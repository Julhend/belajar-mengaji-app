...
public class Belajar_Tanwin_Fathah_Tain extends Activity {
    ImageView TampilGambar;
    ImageButton show,hide,help,next_button;
    protected void onCreate (Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tanwin_fatah_tain);
     ...
     //  final MediaPlayer SuaraShad = MediaPlayer.create(this, R.raw.tanwin_fatah_sh);
      ...
      //  final MediaPlayer SuaraWawu = MediaPlayer.create(this, R.raw.tanwin_fatah_syan);
        ...
        ImageButton ButtonSuara = (ImageButton) this.findViewById(R.id.tain_an); //variabel button
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent explicit_intent = new Intent(Belajar_Tanwin_Fathah_Tain.this,
